...
def test_crear_antibiotico_invalido (test_CRUD_antibiotico):
    test_producto_invalido = Producto (nombre_producto = "Vacuna",
                                       registro_ICA = "999-AB",
                                       dosis = 5,
                                       concentracion = 100,
                                       frecuencia_aplicacion = Frecuencia_aplicacion.DIAS,
                                       tipo_producto = Tipo_producto.VACUNA,
...
def test_actualizar_antibiotico(test_CRUD_antibiotico, test_producto_antibiotico):
    test_CRUD_antibiotico.crear_antibiotico(test_producto_antibiotico)
    actualizado = test_CRUD_antibiotico.actualizar_antibiotico("Oxitetraciclina", nuevo_peso = 430, nuevo_tipo_animal = Animal.BOVINO)
    assert actualizado
