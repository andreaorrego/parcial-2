from Model.antibiotico import Antibiotico, Animal
...
def test_antibiotico():
    ...
    assert antibiotico1.valor_producto == "22.800"
    ...
    assert antibiotico3.valor_producto == "34.900"